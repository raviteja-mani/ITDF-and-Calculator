...
public final class CropImage {
     ...
     * Result will be recieved in {@link AppCompatActivity#onActivityResult(int, int, Intent)} and can be retrieved
     ...
     *
     * @param data result data intent as received in {@link AppCompatActivity#onActivityResult(int, int, Intent)}.
